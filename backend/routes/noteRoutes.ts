...
import { createNote, deleteNote, getAllNotes, getNoteById, searchNotes, updateNote, pinNote, archiveNote, getNotesByIsPinned, getNotesByCategory, getNotesByIsArchived } from '../controllers/noteController';
